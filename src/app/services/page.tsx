...
const servicesData: ServiceCardProps[] = [
  {
    ...
    description:
      'Comprehensive removal of all items from a property, including furniture, personal effects, carpets, and white goods. Ideal for probate, downsizing, or preparing a property for sale/let.',
    icon: Home,
  ...
  },
  {
    ...
    description:
      'Targeted removal of specific items or from particular rooms, such as attics, garages, or sheds. Flexible to suit your exact requirements.',
    icon: Home,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description:
      'Professional clearance of office spaces, retail units, and other commercial properties. We handle furniture, IT equipment, documents, and general waste.',
    icon: Briefcase,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description:
      'Collection and disposal of green waste, soil, rubble, old sheds, garden furniture, and other outdoor items. We help you reclaim your garden.',
    icon: Trash2,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description:
      'Removal of construction and demolition waste, including rubble, plasterboard, wood, and packaging. We ensure sites are left clean and tidy.',
    icon: Building,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description:
      'Eco-friendly disposal of Waste Electrical and Electronic Equipment (WEEE) and commitment to recycling as much waste as possible.',
    icon: Recycle,
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    description:
      'Sensitive and discreet clearance services for properties affected by hoarding. We work with compassion and understanding.',
    icon: AlertTriangle,
    imageUrl: 'https://placehold.co/600x400.png',
...
export default function ServicesPage() {
  ...
  // Convert PocketBase services to ServiceCard format
  const dynamicServices = services.map(service => ({
    title: service.title,
    description: service.description,
    icon: iconMap[service.icon_name as keyof typeof iconMap] || Home,
    imageUrl: service.image_url || 'https://placehold.co/600x400.png',
    imageAlt: service.title,
    imageHint: service.image_hint || service.title.toLowerCase(),
    learnMoreLink:
      service.learn_more_link ||
      `/booking?service=${service.title.toLowerCase().replace(/\s+/g, '-')}`,
  }));

  // Use dynamic services or fallback to static
  const displayServices = services.length > 0 ? dynamicServices : servicesData;
      ...
      >
        <div className="text-center">
          <h2 className="font-headline text-3xl sm:text-4xl font-bold mb-6">
            Ready for a Clearer Space?
          </h2>
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-xl mx-auto">
            Contact us today for a free, no-obligation quote tailored to your
            specific clearance needs.
          </p>
          <Button
            asChild
            size="lg"
