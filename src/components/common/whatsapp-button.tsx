...
export function WhatsAppButton({
  ...
  const iconClassName =
    variant === 'button' && size !== 'icon' ? 'mr-2 h-5 w-5' : 'h-5 w-5';

  const baseStyle =
    'bg-[#25D366] text-white hover:bg-[#1DAE56] rounded-full shadow-lg';
  ...
  return (
    ...
    >
      <a href={whatsAppLink} target="_blank" rel="noopener noreferrer">
        <WhatsAppSvgIcon className={iconClassName} />
