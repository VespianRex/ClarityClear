...
const steps = [
  ...
  },
  {
    ...
    schema: CollectionDetailsSchema,
  },
...
const volumeEstimates = [
  'Single Item',
  'Small Van Load (e.g., 1-2 rooms)',
  'Medium Van Load (e.g., small flat)',
  'Large Van Load (e.g., 2-3 bed house)',
  'Luton Van Load (e.g., 3+ bed house)',
  'Unsure / Other',
];
const timeSlots = [
  'Morning (8am - 12pm)',
...
export function BookingForm() {
  ...
  const methods = useForm<BookingFormData>({
    ...
    defaultValues: {
      // Initialize all fields to avoid uncontrolled to controlled input warnings
      fullName: '',
      email: '',
      phone: '',
      addressLine1: '',
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input type="tel" placeholder="e.g. 07123456789" {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      />
      <h3 className="text-xl font-headline font-semibold text-primary pt-4">
        Collection Address
      </h3>
      <FormField
        control={control}
    ...
    <div className="space-y-6">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea
                placeholder="e.g. Old sofa, fridge, approx 10 bags of mixed household waste, garden cuttings"
                {...field}
              />
            </FormControl>
            <FormMessage />
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              <FormControl>
                <SelectTrigger>
                  <SelectValue placeholder="Select an estimated volume" />
                </SelectTrigger>
              </FormControl>
              <SelectContent>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>
              Access Restrictions / Parking Information (Optional)
            </FormLabel>
            <FormControl>
              <Textarea
                placeholder="e.g. Narrow street, permit parking required, items on 3rd floor no lift."
                {...field}
              />
            </FormControl>
            <FormMessage />
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="space-y-3">
            <FormLabel>
              Is there available parking for a van at the property?
            </FormLabel>
            <FormControl>
              <RadioGroup
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border p-6 shadow-sm">
        ...
        <div>
          ...
          <p>
            <strong>Estimated Volume:</strong> {formData.estimatedVolume}
          </p>
          <p>
          ...
          <p>
            ...
            {formData.hasParking
              ? formData.hasParking.charAt(0).toUpperCase() +
                formData.hasParking.slice(1)
              : 'Not specified'}
          </p>
          {formData.accessRestrictions && (
            <p>
              <strong>Access Info:</strong> {formData.accessRestrictions}
            </p>
          )}
        </div>
      </div>
      <p className="text-sm text-muted-foreground">
        Please review your information carefully. By submitting, you agree to
        our terms and conditions. We will contact you to confirm the booking and
